...
const BANKS = [
  { code: "BANGKOK BANK", name: "กรุงเทพ", icon: "🔵" },
  { code: "Kasikornbank", name: "กสิกรไทย", icon: "🍃" },
  { code: "Krung Thai Bank", name: "กรุงไทย", icon: "🐉" },
  { code: "TMBThanachart Bank", name: "TTB", icon: "🔶" },
  { code: "The Siam Commercial Bank", name: "ไทยพาณิชย์", icon: "🟣" },
  { code: "Citibank Thailand", name: "Citibank", icon: "🌐" },
  { code: "Standard Chartered", name: "Standard Chartered", icon: "🏛️" },
  { code: "CIMB Thai Bank", name: "CIMB Thai", icon: "🔺" },
  { code: "United Overseas Bank", name: "UOB", icon: "🔴" },
  { code: "Krungsri", name: "กรุงศรี", icon: "🟡" },
  { code: "Government Savings Bank", name: "ออมสิน", icon: "🐷" },
  { code: "Government Housing Bank", name: "ธอส.", icon: "🏠" },
  {
    code: "Bank for Agriculture and Agricultural Cooperatives",
    name: "ธ.ก.ส.",
    icon: "🌾",
  },
  { code: "Export-Import Bank of Thailand", name: "EXIM Bank", icon: "🏦" },
  { code: "Bank of China", name: "Bank of China", icon: "🇨🇳" },
  { code: "Islamic Bank of Thailand", name: "Islamic Bank", icon: "🌙" },
  { code: "TISCO Bank", name: "TISCO", icon: "🔵" },
  { code: "KIATNAKIN BANK", name: "เกียรตินาคิน", icon: "🟦" },
  { code: "Thai Credit Retail Bank", name: "ไทยเครดิต", icon: "🟩" },
  { code: "Land and Houses Bank", name: "LH Bank", icon: "🟨" },
  {
  ...
  {
    code: "Sumitomo Mitsui Trust Bank",
    name: "Sumitomo Mitsui Trust",
    icon: "🇯🇵",
  },
  { code: "SME Development Bank", name: "SME Bank", icon: "🏗️" },
  { code: "TrueMoney", name: "TrueMoney", icon: "🔴" },
  {
    code: "JP Morgan Chase Bank Bangkok Branch",
    name: "JP Morgan",
    icon: "🏦",
  },
  { code: "Sumitomo Mitsui Banking Corporation", name: "SMBC", icon: "🇯🇵" },
  { code: "Mega International Commercial Bank", name: "Mega ICB", icon: "🇹🇼" },
  {
    code: "Bank Of America National Association",
    name: "Bank of America",
    icon: "🇺🇸",
  },
  {
    code: "Hongkong and Shanghai Banking Corporation",
    name: "HSBC",
    icon: "🔴",
  },
  { code: "Deutsche Bank A.G", name: "Deutsche Bank", icon: "🇩🇪" },
  { code: "MIZUHO BANK,LTD.BANKOK BRANCH", name: "Mizuho Bank", icon: "🔵" },
  { code: "BNP Paribas Bangkok Branch", name: "BNP Paribas", icon: "🇫🇷" },
  {
    code: "Industrial and Commercial Bank of China (Thai)",
    name: "ICBC",
    icon: "🟥",
  },
  { code: "American International Group", name: "AIG", icon: "🏢" },
  { code: "Bank of Tokyo-Mitsubishi", name: "MUFG", icon: "🇯🇵" },
  {
    code: "Crédit Agricole Corporate and Investment Bank",
    name: "Crédit Agricole",
    icon: "🇫🇷",
  },
  { code: "Indian Overseas Bank", name: "Indian Overseas Bank", icon: "🇮🇳" },
  { code: "Oversea-Chinese Banking Corporation", name: "OCBC", icon: "🇸🇬" },
  { code: "The Royal Bank of Scotland (RBS)", name: "RBS", icon: "🏴󠁧󠁢󠁳󠁣󠁴󠁿" },
  { code: "RHB Bank", name: "RHB Bank", icon: "🇲🇾" },
  { code: "Bank of Thailand", name: "ธนาคารแห่งประเทศไทย", icon: "🏛️" },
];
